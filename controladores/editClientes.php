...
$cuery = "SELECT nombre, correo, telefono FROM clientes WHERE nombre = '$nombreFijo'";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form method="post" role="form" id="quickForm" action="act_Cliente.php" method="post">
                ...
                <tr>
                <td><B>Telefono:</B></td>
                <td> <INPUT TYPE="text" NAME="telefono" id="usuario" value="<?php echo $telefono; ?>" SIZE=22 MAXLENGTH=48 required></td>

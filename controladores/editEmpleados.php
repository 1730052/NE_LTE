...
$cuery = "SELECT nombre, usuario, contra, correo, socio, vehiculo FROM empleados WHERE nombre = '$nombreFijo'";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form method="post" role="form" id="quickForm" action="act_Empleado.php" method="post">
                ...
                <tr>
                <td><B>Usuario:</B></td>
                <td> <INPUT TYPE="text" NAME="usuario" id="nombre" value="<?php echo $usuario; ?>" SIZE=40 MAXLENGTH=50 required></td>

                <tr>
                <td><B>Contraseña:</B></td>
                <td> <INPUT TYPE="text" NAME="contra" id="nombre" value="<?php echo $contra; ?>" SIZE=40 MAXLENGTH=50 required></td>
                ...
                <tr>
                <td><B>Vehiculo:</B></td>
                <td> <INPUT TYPE="text" NAME="vehiculo" id="usuario" value="<?php echo $vehiculo; ?>" SIZE=22 MAXLENGTH=48 required></td>

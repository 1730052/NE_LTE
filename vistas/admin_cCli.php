          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <form action="../controladores/editClientes.php" method="post" role="form" id="quickForm">
                  ...
                  <div class="crudAdmin" align="center">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php foreach ($resultado_Clien as $resultado_Clien){ ?>
                          <?php $nombreUsr = $resultado_Clien -> nombre ?>
                          <td> <?php echo $resultado_Clien -> nombre ?></td>
                          <td> <?php echo $resultado_Clien -> correo ?></td>
                          <td><?php echo $resultado_Clien -> telefono ?></td>
                          <td><form action="../controladores/editClientes.php" method="post">
                                <button class="btn btn-success" type="submit" name="editar"
                                value="<?php echo htmlspecialchars($nombreUsr); ?>">Editar</button>
                              </form>
                            </td>

                            <td><form method="post" action="../controladores/borrar_Cliente.php">

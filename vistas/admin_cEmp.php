          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <form action="../controladores/editEmpleados.php" method="post" role="form" id="quickForm">
                  ...
                  <div class="crudAdmin" align="center">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php foreach ($resultado_Emp as $resultado_Emp){ ?>
                          <?php $nombreUsr = $resultado_Emp -> nombre ?>
                          <td> <?php echo $resultado_Emp -> nombre ?></td>
                          <td> <?php echo $resultado_Emp -> usuario ?></td>
                          <td> <?php echo $resultado_Emp -> correo ?></td>
                          <td><?php echo $resultado_Emp -> socio ?></td>
                          <td><?php echo $resultado_Emp -> vehiculo ?></td>
                          <td><form action="../controladores/editEmpleados.php" method="post">
                                <button class="btn btn-success" type="submit" name="editar"
                                value="<?php echo htmlspecialchars($nombreUsr); ?>">Editar</button>
                              </form>
                            </td>

                            <td><form method="post" action="../controladores/borrar_Emp.php">

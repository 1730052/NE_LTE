          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <a href="agregarViaje.php">
                  <input type="button" name="" value="Añadir" class="btn btn-primary">
                </a>

                <form action="../controladores/editViajes.php" method="post" role="form" id="quickForm">
                  ...
                  <div class="crudAdmin" align="center">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($resultado_Viaj as $resultado_Viaj){ ?>
                          <?php $nombreUsr = $resultado_Viaj -> Id ?>
                          <td> <?php echo $resultado_Viaj -> Cliente ?></td>
                          <td> <?php echo $resultado_Viaj -> Empleado ?></td>
                          <td><?php echo $resultado_Viaj -> Admin ?></td>
                          <td><?php echo $resultado_Viaj -> fecha_solicitud ?></td>
                          <td><?php echo $resultado_Viaj -> fecha_fin ?></td>
                          <td><?php echo $resultado_Viaj -> material ?></td>
                          <td><?php echo $resultado_Viaj -> destino ?></td>
                          <td><form action="../controladores/editViajes.php" method="post">
                                <button class="btn btn-success" type="submit" name="editar"
                                value="<?php echo htmlspecialchars($nombreUsr); ?>">Editar</button>
                              </form>
                            </td>

                            <td><form method="post" action="../controladores/borrar_Viaje.php">

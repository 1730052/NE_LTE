        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form role="form" id="quickForm" action="../controladores/addCliente.php" method="post">
                ...
                <tr>
                <td><B>Número:</B></td>
                <td> <INPUT TYPE="number" NAME="numero" id="usuario" value="" SIZE=22 MAXLENGTH=48 required></td>

                <tr>
                <td ALIGN=CENTER colspan="2">
                <INPUT NAME = "agregar" TYPE="submit" VALUE="Agregar Cliente">

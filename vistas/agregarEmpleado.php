        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form role="form" id="quickForm" action="../controladores/addEmpleado.php" method="post">
                ...
                <tr>
                <td><B>Usuario:</B></td>
                <td> <INPUT TYPE="text" NAME="usuario" id="usuario" value="" SIZE=22 MAXLENGTH=48 required></td>

                <tr>
                <td><B>Contraseña:</B></td>
                <td> <INPUT TYPE="password" NAME="contrasena" id="contrasena" value="" SIZE=22 MAXLENGTH=48 required></td>

                <tr>
                <td><B>Correo:</B></td>
                <td> <INPUT TYPE="email" NAME="correo" id="correo" value="" required></td>
                ...
                <tr>
                <td><B>Vehiculo:</B></td>
                <td> <INPUT TYPE="text" NAME="vehiculo" id="vehiculo" value="" SIZE=22 MAXLENGTH=20 required></td>

                <tr>

                <td ALIGN=CENTER colspan="2">
                <INPUT NAME = "agregar" TYPE="submit" VALUE="Agregar Empleado">
